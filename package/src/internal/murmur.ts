...
export function murmur(key: string): number {
  // The previous implementation used this seed.
  // We keep it to not mix any buckets around.
  const seed = 0x01234567;
  return x86.hash32(key, seed);
}
